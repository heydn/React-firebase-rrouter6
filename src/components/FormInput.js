...
export const FormInput = forwardRef(({type, placeholder, onChange, onBlur, name, label, error},ref) => {
  
  const errorClassLabel = error ? 
  "block mb-2 text-sm font-medium text-red-700 dark:text-red-500 text-left"
  : "block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 text-left"
